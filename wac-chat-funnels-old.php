...
class WAC_Chat_Funnels {
    ...
    public function funnel_config_metabox($post) {
        ...
        <h3><?php _e('Editor de Funnel - SOLO TIPO MENSAJE', 'wac-chat-funnels'); ?></h3>
        <div id="wac-funnel-builder">
            <div id="wac-steps-container">
                <!-- Solo un paso inicial vacío -->
            </div>
        ...
        function addNewStep() {
            ...
            console.log(`Nuevo paso tipo MENSAJE agregado: ${stepId}`);
        }
        ...
        function loadSavedConfiguration() {
            ...
            if (typeof wacSavedSteps !== 'undefined' && wacSavedSteps && Object.keys(wacSavedSteps).length > 0) {
                ...
                // Aplicar datos a los campos existentes
                ...
                console.log('No hay configuración guardada, empezando limpio');
            }
        }
        
        // Funciones simplificadas - solo para tipo Mensaje
